...
nx.draw(G, pos, node_size=3, node_color='yellowgreen')
nx.draw(G, pos, nodelist=['8', '108', '118', '105'], node_size=10, node_color='yellow')
nx.draw(G, pos, nodelist=['1'], node_size=12, node_color='orange')
nx.draw(G, pos, nodelist=['38', '39', '40'], node_size=15, node_color='red')
